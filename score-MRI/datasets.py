...
class ResizeAndPad:
    def __init__(self, output_size):
        """
        Initialize with the target output size.
        :param output_size: tuple (new_width, new_height)
        """
    ...
    def __call__(self, img):
        ...
        :param img: a PIL Image or a PyTorch tensor
        """
        # Convert to PIL Image if the input is a tensor
